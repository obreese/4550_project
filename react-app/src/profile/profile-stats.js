        ...
        <>
            <ul className="nav nav-pills mb-2">
                <li className={"list-group-item"}>
                    <Link className={`nav-link p-1 ${currentList === "posts" ? "active" : ""}`}
                          onClick={setPosts}>{user.posts.length} Posts</Link>
                </li>
                <li className={"list-group-item"}>
                    <Link className={`nav-link p-1 ${currentList === "followers" ? "active" : ""}`}
                          onClick={setFollowers}>{user.followers.length} Followers</Link>
                </li>
                <li className={"list-group-item"}>
                    <Link className={`nav-link p-1 ${currentList === "following" ? "active" : ""}`}
